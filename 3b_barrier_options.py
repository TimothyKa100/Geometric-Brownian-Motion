...
def mc_barrier_call(
    ...
    barrier_type options:
        'down-and-out'  : S must NEVER fall below barrier  (else worthless)
        'down-and-in'   : S must touch/cross below barrier (else worthless)
        'up-and-out'    : S must NEVER rise above barrier  (else worthless)
        'up-and-in'     : S must touch/cross above barrier (else worthless)
    """
